    ...
    <div className="treasure-modal-overlay" onClick={(e) => {
      ...
      <div className="treasure-modal" onClick={(e) => {
        ...
        <div className="modal-header">
          <h2>💎 Crystal Collection Challenge</h2>
          ...
          <div className="question-section">
            <div className="crystal-info">
              <div className="crystal-visual">
                ...
                />
                <p>🔒 This crystal is protected by a math puzzle!</p>
              </div>
            </div>
            ...
            {showResult && (
              <div className={`result ${isCorrect ? 'correct' : 'incorrect'}`}>
                ...
                {isCorrect && <p>💎 Crystal collected! Well done!</p>}
                {!isCorrect && <p>❌ The crystal remains protected. Try again!</p>}
              </div>
            )}
          </div>
